                    ...
                    <div class="facility-card hover-card">
                        <div class="facility-info">
                            ...
                            <div class="facility-desc" id="chip-desc-en">
                                For characterizing integrated photonic devices and optoelectronic chips for various applications, including optical signal processing, photonic computing, entangled photon-pair generation, and integrated lidars. Key facilities include:<br>
                                • Wavelength tunable infrared lasers<br>
                                • High-speed modulators and detectors<br>
                                • Optical spectra analyzers<br>
                                • RF sources, spectra analyzers, and network analyzers<br>
                                • Superconductor-based single-photon counters<br>
                                • Liquid Helium cryogenic probe station
                            </div>
                            <div class="facility-desc" id="chip-desc-cn" style="display: none;">
                                用于表征各类应用场景下的集成光子器件与光电芯片，包括光信号处理、光子计算、纠缠光子对产生、集成激光雷达等方向。核心设备包括：<br>
                                • 波长可调谐红外激光器<br>
                                • 高速调制器与探测器<br>
                                • 光频谱分析仪<br>
                                • 射频源、频谱分析仪与网络分析仪<br>

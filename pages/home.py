...
CSS = """
        ...
        @media (max-width: 768px) {
            ...
            .banner-title small { font-size: 14px; }
...
BODY = """
    <div class="banner">
        <h1 class="banner-title" id="banner-title-en">MacroPhotonic Lab
            <small>Southern University of Science and Technology</small>
        </h1>
        <h1 class="banner-title" id="banner-title-cn" style="display: none;">宏观光子实验室
            <small>南方科技大学</small>
        </h1>
        <p class="banner-desc" id="banner-desc-en">
            We're a research group working at the intersection of photonic chips and macroscopic quantum states of light. Our research spans optical characterization, nanofabrication, and theoretical modeling. <strong>On the application side, we develop advanced photonic devices and chips for optical information and optical computing</strong> — integrated photonic chips, III-V semiconductor lasers, and opto-electro-mechanical chips. <strong>On the science side, we focus on novel physics of light-matter coupling</strong>, striving to realize and control macroscopic quantum states such as Bose-Einstein condensation on photonic chip platforms, and to explore their applications in next-generation photonic chips.
        </p>
        <p class="banner-desc" id="banner-desc-cn" style="display: none;">
            我们从事光子芯片与宏观光量子物态的交叉科学研究，研究内容涵盖光电测量、纳米加工、理论建模等方向。<strong>应用层面，我们研发面向光信息与光计算领域的先进光子器件及芯片</strong>，包括集成光子芯片、III-V 族半导体激光器、光机电芯片等；<strong>基础科学层面，我们聚焦光-物质耦合的新奇物理现象</strong>，致力于在光子芯片平台上实现并操控玻色 - 爱因斯坦凝聚等宏观量子物态，探索其在下一代光子芯片领域的应用。
        </p>
    </div>
    ...
    <div class="news-section">
        <div class="news-card">
            ...
            <div class="news-item">
                <span class="news-date">Sep 1, 2026</span>
                <span class="news-text" id="news3-en">We warmly welcome Tianyu Xu, Jiong Ouyang, and Jie Liu to join our lab as master's students.</span>
                <span class="news-text" id="news3-cn" style="display: none;">欢迎徐天宇、欧阳炯、刘杰作为硕士研究生加入实验室。</span>
            </div>
            <div class="news-item">

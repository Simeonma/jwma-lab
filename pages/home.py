...
CSS = """
        ...
        .banner::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(100deg, rgba(8, 23, 42, 0.92) 0%, rgba(15, 35, 62, 0.75) 50%, rgba(15, 35, 62, 0.45) 100%);
            z-index: 1;
        }
...
BODY = """
    <div class="banner">
        ...
        <p class="banner-desc" id="banner-desc-en">
            We work at the intersection of <strong>photonic chips</strong> and <strong>macroscopic quantum states of light</strong> — from integrated photonic circuits and III-V semiconductor lasers to polariton condensates and topological photons.
        </p>
        <p class="banner-desc" id="banner-desc-cn" style="display: none;">
            我们从事<strong>光子芯片</strong>与<strong>宏观光量子物态</strong>的交叉研究——从集成光子电路、III-V 族半导体激光器，到极化激元凝聚与拓扑光子。
        </p>
        <div style="max-width: 1200px; margin: 0 auto; position: relative; z-index: 2;">
            <span id="banner-cta-en" style="display: inline;"><a href="research.html" class="banner-cta">Explore our research →</a></span>
            <span id="banner-cta-cn" style="display: none;"><a href="research.html" class="banner-cta">了解我们的研究方向 →</a></span>
        </div>
    </div>

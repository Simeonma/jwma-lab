            ...
            <div class="opening-section">
                ...
                <div class="position-card hover-card">
                        ...
                        <div class="position-desc" id="postdoc-desc-en">
                            ...
                            • Career development: postdocs who stay in Shenzhen for research work after completing their postdoc term and sign a labor (employment) contract of 3 years or more with a local enterprise or institution may apply for the Shenzhen postdoc research grant for staying in/coming to Shenzhen, receiving 100,000 RMB per year for up to 3 years (subject to the latest Shenzhen application requirements)<br>
                            • Outstanding postdocs have the opportunity to be promoted to Research Assistant Professor or Assistant Researcher upon completion
                        </div>
                        <div class="position-desc" id="postdoc-desc-cn" style="display: none;">
                            ...
                            • 出站留深从事科研工作并与本市企事业单位签订 3 年以上劳动（聘用）合同的，可申请深圳市博士后留深来深科研资助，每年 10 万元，共资助 3 年（以深圳市最新申报要求为准）<br>
                            • 结题后表现优秀者有机会晋升为研究助理教授/助理研究员。
                        </div>
                    </div>
                    ...
                    <div class="position-card hover-card">
                        ...
                        <div class="position-desc" id="phd-desc-en">
                            ...
                            <strong>Preferred (not required)</strong>:<br>
                    ...
                    <div class="position-card hover-card">
                        ...
                        <div class="position-desc" id="master-desc-en">
                            If you are curious but not yet sure whether research is your future path, a master's program is the perfect time to find out. We welcome master's students interested in the engineering and physics of photonics. For admissions details, please refer to the <a href="https://gs.sustech.edu.cn/#/admission/index">University Admissions Website</a>.<br><br>
                            <strong>Mentoring Philosophy</strong>:<br>
                            New members get hands-on training from senior lab members and the PI, then gradually move into independent projects. You pick your research direction based on what interests you. We'll work together on research ideas and guidance, exploring scientific frontiers and publishing high-impact results. Whether you eventually choose to pursue further studies or move to industry, we will support your decision.<br><br>
                            <strong>Basic Requirements</strong>:<br>
                            • Bachelor's degree in optoelectronics, electronic engineering, physics, or related disciplines.<br>
                            • Strong academic background (GPA ≥ 85/100 or 3.5/4.0) from top-tier universities.<br><br>
                            <strong>Preferred (not required)</strong>:<br>
                            • Experience in photonic chip design, numerical simulation, or optical experiments<br>
                            • Some programming experience (including making good use of AI-assisted tools)
                        </div>
                        <div class="position-desc" id="master-desc-cn" style="display: none;">
                            如果你怀有好奇心，但还不确定未来是否以科研为业，硕士阶段正是探索的最好时机。我们欢迎对光子学的工程和物理感兴趣的硕士研究生加入。招生详情请参考<a href="https://gs.sustech.edu.cn/#/admission/index">学校官网</a>。<br><br>
                            <strong>培养理念</strong><br>
                            新人会由PI或有经验的高年级学生指导基础训练，逐步过渡到独立项目；学生可根据个人兴趣和特长选择研究方向，PI会提供可行的科研想法和技术指导，共同探索科学前沿、发表高水平成果。无论你最终选择继续深造还是走向产业，我们都会支持你的决定。<br><br>
                            <strong>基本要求</strong><br>
                            • 光电信息工程、电子工程、物理学或相关专业本科学历<br>
                            • 顶尖高校毕业，具备优秀的学术背景（GPA ≥ 85/100 或 3.5/4.0）<br><br>
                            <strong>优先考虑（非必须）</strong><br>
                            • 有过光子芯片设计、数值模拟或光学实验的经历<br>
                            • 具备一定编程基础（包括善用 AI 辅助工具）
                        </div>
                    </div>

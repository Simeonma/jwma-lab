            ...
            <div class="opening-section">
                ...
                <div class="position-card hover-card">
                        ...
                        <div class="position-desc" id="postdoc-desc-en">
                            ...
                            • Talent programs: the group assists eligible postdocs in applying for postdoctoral talent programs; successful applicants can receive subsidies totaling up to <strong>1,000,000 RMB</strong> (not concurrently with the Guangdong and Shenzhen in-post living subsidies)<br>
                        ...
                        <div class="position-desc" id="postdoc-desc-cn" style="display: none;">
                            ...
                            • 课题组协助符合条件的博士后申请博士后人才项目，申请成功者可享受总计高达 <strong>100 万元</strong>的补贴（与广东省及深圳市在站博士后生活补贴不同时享受）<br>
                            • 在站期间可依托学校申请深圳市公租房；未使用公租房的，可享受两年税前 2800 元/月的住房补贴<br>
